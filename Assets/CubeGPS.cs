...
public class CubeGPS : MonoBehaviour
{
    ...
    IEnumerator GetCoordinates()
    {
        ...
        while (true)
        {
            ...
            if (maxWait < 1)
            {
                distanceTextObject.GetComponent<TextMesh>().text = "Timed out";
                yield break;
            }
            ...
            {
                distanceTextObject.GetComponent<TextMesh>().text = "Unable to determine device location";
                yield break;
            }
            else
            {
                ...
                distanceTextObject.GetComponent<TextMesh>().text = "Location: " + Input.location.lastData.latitude + " " + Input.location.lastData.longitude + " " + Input.location.lastData.altitude + " " + Input.location.lastData.horizontalAccuracy + " " + Input.location.lastData.timestamp;
    ...
    public void Calc(float lat1, float lon1, float lat2, float lon2)
    {
        ...
        distanceTextObject.GetComponent<TextMesh>().text = "Distance: " + distance;
    ...
    void Start()
    {
        ...
        distanceTextObject.GetComponent<TextMesh>().text = "Distance: 10";
